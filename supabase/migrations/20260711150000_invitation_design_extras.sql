-- خيارات التخصيص المتقدم لتصميم الدعوة (الإطارات، الزوايا، الأحجام، الشعار...)
-- تُخزّن كحقل JSON واحد مرن.

ALTER TABLE public.private_invitations
  ADD COLUMN IF NOT EXISTS design_extras JSONB NOT NULL DEFAULT '{}';

-- تحديث دالة جلب الدعوة بالرمز لتشمل التخصيصات (وحالة فتح الدعوة)
